...
class ProdCategoryPageController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin/shop/category',compact('cat'));
    }
    ...
    public function update(Request $request, $id)
    {
            ...
            try {
                ...
                if($request->input('prodparent'))
                    $prodcat->PRODT_PARENT = $request->input('prodparent');
                $prodcat->save();
                return redirect('admin/shop/category')->with('success', 'Successfully record is updated!');
            } catch (\Exception $e) {
                return redirect('admin/shop/category')->with('error', $e->getCode());
            }
    }
